...
use Lenevor\Actions\Concerns\ForListener;
use Lenevor\Actions\Decorators\ListenerDecorator;
use Syscodes\Components\Events\Dispatcher;

class ListenerPattern extends DesignPattern
{
    /**
     * Get the trait.
     * 
